        ...
        confirm.open(
            <div className='p-2' >
                <div className='text-orange-600 text-center animate-pulse duration-75'>
                    <span className='font-extrabold'>Warning!</span> ${amount} will be deducted from your wallet.
                </div>
    ...
    return (
        <div className={style('p-6').card()}>
            <div className='pb-1 text-slate-700 text-lg'>
                Your Wallet balance is <span className='font-extrabold text-slate-900'>${balance}</span>
            </div>
            ...
            <Form onSubmit={onSubmit}>
                <div className={style('grid grid-cols-1 md:grid-cols-2 gap-4')}>
                    ...
                    <div className='flex justify-center items-center'>
                        <Button color='blue' type='submit' disabled={!balance || !amount || amount < 10 || balance < 10 || balance < amount}>
                            Request Withdrawal
                        </Button>
                    </div>
                </div>
