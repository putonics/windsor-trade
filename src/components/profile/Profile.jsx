...
const Profile = props => {
    ...
    const [state, setState] = React.useState({
        ...
        idproof: login.info.idproof || { name: '', number: '', issuingAuthority: '' },
        cryptoWalletAddress: login.info.cryptoWalletAddress || '',
        bankAccount: login.info.bankAccount || { acName: '', acNo: '', ifsc: '', bank: '', branch: '' }
    })
        ...
        confirm.open(
            <div className='p-2'>
                <div className='text-orange-600 text-center animate-pulse duration-75'>
                    <span className='font-extrabold'>Warning!</span> This will change your personal data.
                </div>
        ...
        <>
            <Form onSubmit={onSubmit}>
                <div className={style().card()}>
                    <div className={style('md:gap-6 gap-0 mx-2 grid md:grid-cols-2 grid-cols-1')}>
                        <div className='p-6'>
                            ...
                            <TextBox
                                ...
                                onChange={cryptoWalletAddress => setState({ ...state, cryptoWalletAddress })}
                            />
                        </div>
                        <div className='p-6'>
                            <Select
                            ...
                            <div className='p-1 flex flex-row justify-center items-center'>
                                <img className='w-10 h-10 border border-solid border-slate-200'
                                    src={`https://countryflagsapi.com/svg/${CountryCodes.find(c => c.code === state.countrycode).name}`}
                                />
                                <div className='p-1 flex flex-row justify-center items-center'>
                            ...
                            <TextBox
                                ...
                                onChange={name => setState({ ...state, idproof: { ...state.idproof, name } })}
                            />
                            <TextBox
                                required
                                ...
                                onChange={number => setState({ ...state, idproof: { ...state.idproof, number } })}
                            />
                            <TextBox
                                required
                                ...
                                onChange={issuingAuthority => setState({ ...state, idproof: { ...state.idproof, issuingAuthority } })}
                            />
                        </div>
                    </div>
                </div>
                    ...
                    <div className={style('md:gap-6 gap-0 mx-2 grid md:grid-cols-2 grid-cols-1')}>
                        <div className='p-6'>
                            ...
                            <TextBox
                                ...
                                onChange={acName => setState({ ...state, bankAccount: { ...state.bankAccount, acName } })}
                            />
                            <TextBox
                                required
                                disabled={busy}
                                ...
                                onChange={acNo => setState({ ...state, bankAccount: { ...state.bankAccount, acNo } })}
                            />
                            <TextBox
                                required
                                disabled={busy}
                                ...
                                onChange={ifsc => setState({ ...state, bankAccount: { ...state.bankAccount, ifsc } })}
                            />
                        </div>
                        <div className='p-6'>
                            <TextBox
                                ...
                                onChange={bank => setState({ ...state, bankAccount: { ...state.bankAccount, bank } })}
                            />
                            <TextBox
                                required
                                disabled={busy}
                                ...
                                onChange={branch => setState({ ...state, bankAccount: { ...state.bankAccount, branch } })}
                            />
                            <div className='text-red-600 text-center py-4 my-4'>
                                {error}
                            </div>
            ...
            <div className='flex flex-col justify-center items-center'>
                <div className={style('mt-6 p-2 w-fit').card()}>
                    <QRCode value={login?.info?.cryptoWalletAddress || 'NO-CRYPTO-WALLET-ADDRESS-GIVEN'} />
                </div>
                <div className='mt-2 mb-6 text-xs'>{login?.info?.cryptoWalletAddress || 'NO-CRYPTO-WALLET-ADDRESS-GIVEN'}</div>
            </div>
        </>
    )
}
