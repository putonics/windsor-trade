    ...
    <div className="py-6">
      <table className=" border ">
        <thead className="border  bg-violet-300 text-stone-700 text-sm font-serif ">
          ...
          <th className="">
            How many direct members should have a minimum of $100 package?{" "}
          </th>
        ...
        <tbody className="">
          ...
          <tr className="text-thin border bg-stone-300 text-slate-500 font-serif">
            <td className="text-sm  font-thin">
              <img className="w-8" src={assets.ruby} />
              Ruby
            </td>
          ...
          <tr className="text-thin border bg-stone-300 text-slate-500 font-serif">
            <td className="text-sm  font-thin">
              <img className="w-8" src={assets.pearl} />
              Pearl
            </td>
            <td className="">$100</td>
            <td className="">20</td>
          ...
          <tr className="text-thin border bg-stone-300 text-slate-500 font-serif">
            <td className="text-sm  font-thin">
              <img className="w-8" src={assets.diamond} alt="" />
              Diamond
            </td>
            <td className="">$100</td>
            <td className="">50</td>
