...
const WindsorCoin = props => {
    ...
    return (
        user.docid === ADMINDOCID ? <></> :
            <div className='flex justify-center items-center p-4 gap-2 md:text-xl text-sm'>
                <div className='text-yellow-600 text-center'>You won! </div>
                <img src='https://windsorcryptocoin.com/img/bg-img/bg-2.png' className='w-14 h-14 animate-bounce' />
                <div className='text-yellow-600 text-center'>&times; {coins}  WINDSOR coins</div>
            </div>
    )
}
